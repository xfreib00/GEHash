...
\projectinfo{
  ...
  title.cs={Evoluční návrh hašovacích funkcí pomocí gramatické evoluce},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Evolutionary Design of Hash Functions Using Grammatical Evolution}, % název práce v angličtině / thesis title in english
  ...
  author.surname={Freiberg},   % příjmení autora / author surname 
  ...
  supervisor.surname={Sekanina},   % příjmení školitele / supervisor surname
